...
class GraphqlController < ApplicationController
  ...
  # Remove o before_action :authenticate_user! para permitir mutations públicas
  # A autenticação será tratada nas mutations/fields individuais quando necessário
